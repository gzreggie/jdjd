...
[task_local]
# 京东赚赚
10 0 * * * https://raw.githubusercontent.com/gzreggie/jdjd/main/jd_jdzz.js, tag=京东赚赚, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jdzz.png, enabled=true

================Loon==============
[Script]
cron "10 0 * * *" script-path=https://raw.githubusercontent.com/gzreggie/jdjd/main/jd_jdzz.js,tag=京东赚赚

===============Surge=================
京东赚赚 = type=cron,cronexp="10 0 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/gzreggie/jdjd/main/jd_jdzz.js

============小火箭=========
京东赚赚 = type=cron,script-path=https://raw.githubusercontent.com/gzreggie/jdjd/main/jd_jdzz.js, cronexpr="10 0 * * *", timeout=3600, enable=true
 */
const $ = new Env('京东赚赚');
